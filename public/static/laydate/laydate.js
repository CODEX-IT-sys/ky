    ...
    */
    ...
    Class.prototype.position = function(){
        var that = this
            ...
            }, margin = 5, left = rect.left, top = rect.bottom, inner_width = rect.width ;
        ...
        //如果右侧超出边界
				...
				//如果右侧超出边界*并且里面带有时间选择器时分秒，因为是默认的宽度值550px
				if(options.type === 'datetime'){
				    if(left + 550 + margin > winArea('width')){
				        left = left + inner_width - 550;	
				    } 
				}
