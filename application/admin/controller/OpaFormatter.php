...
use app\facade\TjOpaFormatter as TjOpaFormatterModel;
...
// 统计报表 排版人员综合考核 控制器
class OpaFormatter extends Controller
{
    // (手动填写表格)
    public function index(Request $request, $type = '', $time = '', $field = '', $keyword = '', $limit = 50)
    {
        // 数据库表字段集
        $colsData = getAllField('ky_tj_opa_formatter');
        ...
        // 调用模型获取列表
        $list = TjOpaFormatterModel::getList($s, $d, $field, $keyword, $limit);
    ...
    public function update(Request $request)
    {
        ...
        TjOpaFormatterModel::update($data);
    ...
    {
        // 调用模型删除
        TjOpaFormatterModel::destroy($id);
