...
use app\facade\TjOpaTrRe as TjOpaTrReModel;
...
class OpaTrRe extends Controller
{
    ...
    public function index(Request $request, $type = '', $time = '', $field = '', $keyword = '', $limit = 50)
    {
        ...
        // 调用模型获取列表
        $list = TjOpaTrReModel::getList($s, $d, $field, $keyword, $limit);
