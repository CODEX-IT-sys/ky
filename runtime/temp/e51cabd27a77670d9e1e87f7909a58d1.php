<?php /*a:1:{s:74:"D:\largon\laragon\www\ky\application\admin\view\mk_quote\quotation_en.html";i:1615786782;}*/ ?>
<!doctype html>
<html>
	<head>
		<meta charset="utf-8">
		...
		<div class="tbShow a4-broadwise">
			<div class="tbWrap">
				<div class="tbContent">
					...
					<div class="tbArticle">
						<h2 class="art_title">PROFORMA INVOICE</h2>
						<h6 class="art_attach">No.:<?php echo htmlentities($i['Quote_Number']); ?></h6>
						<div class="artItem">
							<ul>
								<li>
									<b>To: </b>
							...
							<ul>
								<li>
									<b>Date:</b>
									<span><?php echo htmlentities($i['Date']); ?></span>
								</li>
								<li>
									<b>Issued by: </b>
