<?php /*a:2:{s:76:"D:\largon\laragon\www\ky\application\admin\view\my_schedule\my_schedule.html";i:1615786782;s:18:"./layout/list.html";i:1615863909;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
				...
				<div class="layui-row">
					<div class="top">
						<div class="position_lead">
							...
							<a class="on"><?php echo session('language') == '中文'? '我的日程' : 'My Schedule'; ?></a>
						</div>

						<!--<div class="global_btn">
							<a href="my_schedule_el.html" class="layui-btn">新增</a>
						</div>-->
